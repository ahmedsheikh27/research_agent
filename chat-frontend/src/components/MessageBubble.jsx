...
export default function MessageBubble({ message = null, role: roleProp, content: contentProp }) {
  ...
  return (
    <motion.div
      ...
      className={`flex w-full p-4 md:p-6 ${
      ...
      >
        ...
        <div
          className={`flex-1 max-w-2xl rounded-2xl p-4 ${
            isUser ? "bg-primary-500/10" : "bg-dark-800/50"
          }`}
        >
          {/* ASSISTANT MESSAGE */}
          {!isUser ? (
                        ...
                        <div className="flex flex-wrap gap-2">
                          {sources.map((source, i) => (
                            <a
                              ...
                              className="inline-flex items-center gap-1.5 px-2 py-1 rounded-md bg-dark-700 hover:bg-dark-600 border border-dark-600 text-xs text-primary-400 transition-colors"
                            >
